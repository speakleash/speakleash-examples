...
class Chart:
    def __init__(self, PROJECT, CHARTS_FOLDER):
        """
    ...
    def draw_charts(self):
        ...
        for i in df_charts.columns:
            if i == "quality":
                ...
                if not os.path.exists(f"{self.CHARTS_FOLDER}/"):
                    os.makedirs(f"{self.CHARTS_FOLDER}/")
                ...
                fig.write_html(f"{self.CHARTS_FOLDER}/{self.PROJECT}_{i}_hist.html")


if __name__ == '__main__':
    # Select dataset and folder name for charts
    PROJECT = "thesis"
    CHARTS_FOLDER = "charts"

    charts = Chart(PROJECT, CHARTS_FOLDER)
    charts.draw_charts()
